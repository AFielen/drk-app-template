...
export default function FooterAdvisory() {
  return (
    <footer
      className="text-center py-6 sm:py-10 mt-8 border-t"
      style={{ borderColor: 'var(--border)' }}
    >
      <div
        className="font-serif text-base font-bold uppercase tracking-[0.18em] mb-2"
        style={{ color: 'var(--drk)' }}
      >
