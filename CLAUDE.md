...
- **DRK skills** (`drk-postgres`): PostgreSQL & Drizzle Best Practices für DRK-Apps mit Datenbank
...
Vollständiger Entwicklungs-Workflow: Branching, Coding, Testing, PRs. Siehe `.claude/skills/coding-workflow/SKILL.md`.

#### Commit, Push & PR (`commit-push-pr`)
Git-Commits erstellen, pushen und Draft-PRs anlegen. Siehe `.claude/skills/commit-push-pr/SKILL.md`.

#### PR Description (`pr-description`)
Richtlinien für klare, umfassende Pull-Request-Beschreibungen. Siehe `.claude/skills/pr-description/SKILL.md`.

#### Code Review (`code-review`)
Code-Review und PR-Review nach Priorität (Correctness → Security → Reliability → Performance). Siehe `.claude/skills/code-review/SKILL.md`.

#### Code Simplifier (`code-simplifier`)
Nach Code-Änderungen: Review auf Wiederverwendung, Qualität und Effizienz. Siehe `.claude/skills/code-simplifier/SKILL.md`.

#### Repo Skills (`repo-skills`)
Nach dem Klonen eines Repos: Skill-Definitionen scannen und indexieren. Siehe `.claude/skills/repo-skills/SKILL.md`.

### Data Skills

#### Data Triage (`data-triage`)
Router für Daten-Fragen: leitet an data-model-explorer und data-analyst weiter. Siehe `.claude/skills/data-triage/SKILL.md`.

#### Data Analyst (`data-analyst`)
SQL-Queries schreiben, Metriken berechnen, Ergebnisse interpretieren. Siehe `.claude/skills/data-analyst/SKILL.md`.

#### Data Workflow (`data-workflow`)
Orchestrierung von Daten-/Analytics-Aufgaben. Siehe `.claude/skills/data-workflow/SKILL.md`.
